...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative bg-[#f5f5f5] pt-28 py-18 px-6 scroll-mt-24"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col space-y-6">
          {/* Contact Info */}
          <div className="bg-gray-900 text-white border-2 border-red-600 rounded-2xl p-1 text-center shadow-md">
            ...
            <div>
              <h4 className="font-medium">Preeti Kiran</h4>
